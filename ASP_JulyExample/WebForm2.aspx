<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="ASP_JulyExample.WebForm2" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:ListBox ID="ListBox1" runat="server">
                            ...
                            <asp:ListItem Value="11">B</asp:ListItem>
                    ...
                    <td>
                        <asp:Panel ID="Panel1" runat="server" Visible="False">
                            <table class="auto-style1">
                                ...
                                <tr>
                                    <td>
                                        <asp:Image ID="Image1" runat="server" Height="175px" Width="282px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
